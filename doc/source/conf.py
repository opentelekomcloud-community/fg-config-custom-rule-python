...
otcdocs_repo_name = 'opentelekomcloud-community/fg-config-custom-rule-python'
...
# Analytics app name
otcdocs_analytics_app = 'fg-config-custom-rule-python'

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/'
otcdocs_doc_title = 'FunctionGraph and Config Custom Rules in Python'
otcdocs_doc_type = 'dev'
otcdocs_service_category = 'example'
otcdocs_service_title = 'fg-config-custom-rule-python'
otcdocs_service_type = 'sdk'
otcdocs_search_environment = 'hc_de'
otcdocs_search_url = "https://opensearch.eco.tsi-dev.otc-service.com/"


otcdocs_projects = ["fg-config-custom-rule-python"]
...
project = u'fg-config-custom-rule-python'
copyright = f'{current_year}, T Cloud Public Community' 
author = u'T Cloud Public Community'
...
html_title = "fg-config-custom-rule-python"
# html_baseurl = "https://opentelekomcloud-community.github.io/fg-config-custom-rule-python/"
...
# rst_prolog = """
# .. |github_repo| replace:: "https://github.com/opentelekomcloud-community/fg-config-custom-rule-python.git"
# .. role:: strikethrough
# """
# version = "1.0.2"
# release = "1.0.2"
...
extlinks= {
    "github_repo_master": (f'https://github.com/opentelekomcloud-community/fg-config-custom-rule-python/tree/{local_branch}/%s', "%s"),
     "github-issue": (
        "https://github.com/opentelekomcloud-community/fg-config-custom-rule-python/issues/%s",
        "%s",
    ),
    "otc_fg_umn": ("https://docs.otc.t-systems.com/function-graph/umn/%s", "%s"),
    "otc_config_umn": ("https://docs.otc.t-systems.com/config/umn/%s", "%s"),
    ...
    "otc_config_api": ("https://docs.otc.t-systems.com/config/api-ref/%s", "%s"),
...
myst_url_schemes = {
    "http": None,
    "https": None,
    "github": "https://github.com/opentelekomcloud-community/fg-config-custom-rule-python/tree/"+local_branch+"/{{path}}#{{fragment}}",
    "gh-issue": {
        "url": "https://github.com/opentelekomcloud-community/fg-config-custom-rule-python/issue/{{path}}#{{fragment}}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
}
